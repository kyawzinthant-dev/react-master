...
function EventForm({ match, history }) {
  ...
  return (
    <Segment clearing>
        ...
        {({ isSubmitting, dirty, isValid }) => (
          <Form className='ui form'>
            ...
            <Button
              ...
              loading={isSubmitting} type='submit' floated='right' positive content='Submit' />
            <Button
              as={Link}
              to='/events'
              type='submit'
      ...
      <Confirm
        content={selectedEvent?.isCancelled ? 'This will reactivate the event! Sure?' :
          'This will cancelled the event! Sure?'}
        open={confirmOpen}
